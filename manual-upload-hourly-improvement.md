# GitHub手動アップロード用ファイル 副業時給改善シミュレーター
...
3. Vercelのデプロイ完了後、トップページから副業時給改善シミュレーターが開けるか確認します。
4. https://side-income-simulator.vercel.app/hourly-improvement.html と sitemap.xml を確認します。
...
<html lang="ja">
  <head>
    ...
    <meta name="description" content="副業月収、AI副業時給、副業時給改善、副業利益率、副業手取り、副業所得税、副業住民税、新NISA・積立投資、クレカ積立比較、iDeCo節税、配当金、配当再投資、配当生活達成、FIRE達成、会社員FIRE、サイドFIRE、生活防衛資金、老後資金、教育費、学資保険比較、住宅ローン、副業税金・青色申告をまとめて試算できるスマホ対応の資産シミュレーターです。">
    <title>【2026年対応】初心者向け資産シミュレーター22選｜副業・税金・FIRE計算</title>
    <link rel="stylesheet" href="style.css">
    <script>
      window.GA_MEASUREMENT_ID = "G-XM73JD15LP";
    </script>
    <script defer src="script.js?v=20260606-hourly-improvement"></script>
  </head>
  <body></body>
</html>
...
<html lang="ja">
  <head>
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1671825304176893"
     crossorigin="anonymous"></script>
    <meta name="google-site-verification" content="W8lV0ZXsiS6lCYIRGsdxAnk8X0vIfJix8UBz6ie2gnc" />
    <meta http-equiv="refresh" content="0; url=index.html#hourly-improvement">
    <meta name="description" content="副業売上、作業時間、経費、外注費、AIツール利用有無、AI活用時間削減率、目標時給から、現在の実質時給とAI導入後の予想時給、改善余地を分析できます。">
    <title>【2026年対応】初心者向け副業時給改善シミュレーター｜3分でAI効率分析</title>
    <link rel="stylesheet" href="style.css">
    <script>
      window.GA_MEASUREMENT_ID = "G-XM73JD15LP";
    </script>
  ...
  <body>
    <main>
      <div class="app-shell">
        <p><a href="index.html#hourly-improvement">副業時給改善シミュレーターを開く</a></p>
        <footer class="site-footer">
          <nav class="footer-links" aria-label="サイト情報">
...
<html lang="ja">
  <head>
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1671825304176893"
     crossorigin="anonymous"></script>
    <meta name="description" content="副業月収、AI副業、副業時給改善、利益率、手取り、税金、会計ソフト、クレジットカード、AIツールの記事とシミュレーターをまとめたカテゴリページです。">
    <title>【2026年対応】初心者向け副業カテゴリ｜22ツールから目的別に探す</title>
    <link rel="stylesheet" href="style.css">
    <script>
      window.GA_MEASUREMENT_ID = "G-XM73JD15LP";
    </script>
