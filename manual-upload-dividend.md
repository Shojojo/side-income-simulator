...
<html lang="ja">
  <head>
    ...
    <meta name="description" content="副業月収、AI副業時給、副業手取り、副業所得税、副業住民税、新NISA・積立投資、iDeCo節税、配当金、FIRE達成、老後資金、教育費、住宅ローン、副業税金・青色申告をまとめて試算できるスマホ対応の資産シミュレーターです。">
    <title>&#x8cc7;&#x7523;&#x30b7;&#x30df;&#x30e5;&#x30ec;&#x30fc;&#x30bf;&#x30fc;</title>
    <link rel="stylesheet" href="style.css">
    <script>
      window.GA_MEASUREMENT_ID = "G-XM73JD15LP";
    </script>
    <script defer src="script.js?v=20260603-dividend"></script>
  </head>
  <body></body>
</html>
