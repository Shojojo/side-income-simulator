# 副業時間管理シミュレーター追加 手動アップロード用

## 変更ファイル一覧
- index.html
- script.js
- side-time-management.html
- category-side-business.html
- sitemap.xml

## アップロード順
1. side-time-management.html を新規追加
2. script.js を上書き
3. index.html を上書き
4. category-side-business.html を上書き
5. sitemap.xml を上書き

## 追加内容
- 26個目のツールとして副業時間管理シミュレーターを追加
- 本業勤務時間、通勤時間、睡眠時間、家事時間、休日時間、副業作業時間、AI活用有無、AI時短率の入力に対応
- 1日の自由時間、副業可能時間、副業継続可能性、AI導入による改善時間、改善ポイント、FIRE達成への影響を表示
- 副業時給改善シミュレーター、AI副業効率化シミュレーター、FIRE達成シミュレーターへの内部リンクを追加
- FAQ、SEOタイトル、メタディスクリプション、AdSense、Analyticsを追加・維持
- トップページ、副業カテゴリ、sitemap.xmlへ追加

## 確認済み
- node --check script.js OK
- ブラウザで #side-time-management の表示と計算を確認
- トップページのツール数が26個になっていることを確認
- sitemap.xml に side-time-management.html が1件登録済み
- AdSense、Analytics、SEOタイトル、メタディスクリプションあり
...
<html lang="ja">
  <head>
    ...
    <meta name="description" content="副業、税金、投資、FIRE、老後資金、教育費、住宅ローン、固定費削減、AI副業効率化、副業時間管理まで、26種類の初心者向けシミュレーターを検索・カテゴリ別・人気順で探せるスマホ対応サイトです。">
    <title>【2026年対応】初心者向け資産シミュレーター26選｜検索・カテゴリ別で探せる</title>
    <link rel="stylesheet" href="style.css">
    <script>
      window.GA_MEASUREMENT_ID = "G-XM73JD15LP";
    </script>
    <script defer src="script.js?v=20260607-side-time-management"></script>
  </head>
  <body></body>
</html>
```
...
## side-time-management.html 完全内容
...
<html lang="ja">
  <head>
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1671825304176893"
     crossorigin="anonymous"></script>
    <meta name="google-site-verification" content="W8lV0ZXsiS6lCYIRGsdxAnk8X0vIfJix8UBz6ie2gnc" />
    <meta http-equiv="refresh" content="0; url=index.html#side-time-management">
    <meta name="description" content="本業勤務時間、通勤時間、睡眠時間、家事時間、休日時間、副業作業時間、AI活用有無、AI時短率から、1日の自由時間、副業可能時間、継続可能性、FIRE達成への影響を分析できます。">
    <title>【2026年対応】初心者向け副業時間管理シミュレーター｜3分で継続時間を分析</title>
    <link rel="stylesheet" href="style.css">
    <script>
      window.GA_MEASUREMENT_ID = "G-XM73JD15LP";
    </script>
  ...
  <body>
    <main>
      <div class="app-shell">
        <p><a href="index.html#side-time-management">副業時間管理シミュレーターを開く</a></p>
        <footer class="site-footer">
          <nav class="footer-links" aria-label="サイト情報">
            ...
            <a href="index.html#side-time-management">副業時間管理</a>
...
## category-side-business.html 完全内容
...
<html lang="ja">
  <head>
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1671825304176893"
     crossorigin="anonymous"></script>
    <meta name="description" content="副業月収、AI副業、AI副業効率化、副業時給改善、副業時間管理、利益率、手取り、税金、会計ソフト、クレジットカード、AIツールの記事とシミュレーターをまとめたカテゴリページです。">
    <title>【2026年対応】初心者向け副業カテゴリ｜26ツールから目的別に探す</title>
    <link rel="stylesheet" href="style.css">
    <script>
      window.GA_MEASUREMENT_ID = "G-XM73JD15LP";
    </script>
  ...
  <body>
    <main>
      <div class="app-shell content-page">
        <header class="header">
          <h1>副業カテゴリ</h1>
          <p class="lead">副業を始める、収入を伸ばす、時給を改善する、利益率や手取りを確認するためのツールと記事をまとめています。まず月収と時給、利益率、手取りを見て、税金や経費管理へ進むと全体像がつかみやすくなります。</p>
        ...
        <section class="content-panel">
          ...
          <div class="article-list">
            ...
            <a class="article-link" href="index.html#ai-efficiency">
              <strong>AI副業効率化シミュレーター</strong>
              <span>AI導入による時間削減、利益率改善、年間追加利益を確認</span>
            </a>
            <a class="article-link" href="index.html#hourly-improvement">
              <strong>副業時給改善シミュレーター</strong>
              <span>売上、作業時間、AI活用から実質時給を改善</span>
            </a>
            <a class="article-link" href="index.html#side-time-management">
              <strong>副業時間管理シミュレーター</strong>
              <span>本業、睡眠、家事、副業時間から継続可能性を確認</span>
            </a>
