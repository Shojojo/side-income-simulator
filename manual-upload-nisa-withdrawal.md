# GitHub手動アップロード用ファイル NISA取り崩しシミュレーター

## 変更ファイル一覧

- index.html
- script.js
- nisa-withdrawal.html
...
3. Vercelのデプロイ完了後、トップページからNISA取り崩しシミュレーターが開けるか確認します。
4. https://side-income-simulator.vercel.app/nisa-withdrawal.html と sitemap.xml を確認します。
...
<html lang="ja">
  <head>
    ...
    <meta name="description" content="副業月収、AI副業時給、副業時給改善、副業利益率、副業手取り、副業所得税、副業住民税、新NISA・積立投資、NISA取り崩し、クレカ積立比較、iDeCo節税、配当金、配当再投資、配当生活達成、FIRE達成、会社員FIRE、サイドFIRE、生活防衛資金、老後資金、教育費、学資保険比較、住宅ローン、副業税金・青色申告をまとめて試算できるスマホ対応の資産シミュレーターです。">
    <title>【2026年対応】初心者向け資産シミュレーター23選｜副業・税金・FIRE計算</title>
    <link rel="stylesheet" href="style.css">
    <script>
      window.GA_MEASUREMENT_ID = "G-XM73JD15LP";
    </script>
    <script defer src="script.js?v=20260606-nisa-withdrawal"></script>
  </head>
  <body></body>
</html>
...
<html lang="ja">
  <head>
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1671825304176893"
     crossorigin="anonymous"></script>
    <meta name="google-site-verification" content="W8lV0ZXsiS6lCYIRGsdxAnk8X0vIfJix8UBz6ie2gnc" />
    <meta http-equiv="refresh" content="0; url=index.html#nisa-withdrawal">
    <meta name="description" content="現在のNISA資産額、毎月追加投資額、想定年利、取り崩し開始年齢、毎月取り崩し額、運用継続有無、目標維持年数から、何年取り崩せるかと毎月使える額を試算できます。">
    <title>【2026年対応】初心者向けNISA取り崩しシミュレーター｜3分で老後資金計算</title>
    <link rel="stylesheet" href="style.css">
    <script>
      window.GA_MEASUREMENT_ID = "G-XM73JD15LP";
    </script>
  ...
  <body>
    <main>
      <div class="app-shell">
        <p><a href="index.html#nisa-withdrawal">NISA取り崩しシミュレーターを開く</a></p>
        <footer class="site-footer">
          <nav class="footer-links" aria-label="サイト情報">
            <a href="index.html#top">トップ</a>
            <a href="index.html#nisa">新NISA・積立投資</a>
            <a href="index.html#nisa-withdrawal">NISA取り崩し</a>
...
<html lang="ja">
  <head>
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1671825304176893"
     crossorigin="anonymous"></script>
    <meta name="description" content="生活防衛資金、老後資金、NISA取り崩し、iDeCo、新NISA、FIRE、住宅ローン、教育費をまとめて確認できる老後カテゴリページです。">
  ...
  <body>
    <main>
      <div class="app-shell content-page">
        <header class="header">
          <h1>老後カテゴリ</h1>
          <p class="lead">老後資金は、投資、年金、生活費、NISA取り崩し、住宅ローン、教育費の影響を受けます。生活防衛資金も確認しながら、必要額と不足額、準備方法を整理できます。</p>
          <nav class="tool-nav" aria-label="カテゴリリンク">
            <a href="index.html#top">トップ</a>
            <a href="category-side-business.html">副業</a>
            <a href="category-tax.html">税金</a>
...
<html lang="ja">
  <head>
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1671825304176893"
     crossorigin="anonymous"></script>
    <meta name="description" content="FIRE、会社員FIRE、サイドFIRE、生活防衛資金、NISA取り崩し、配当再投資、配当生活達成、新NISA、老後資金をまとめたFIREカテゴリページです。">
  ...
  <body>
    <main>
      <div class="app-shell content-page">
        <header class="header">
          <h1>FIREカテゴリ</h1>
          <p class="lead">FIREを目指す人向けに、必要資産、達成年数、副業収入、NISA取り崩し、配当再投資、配当生活達成、生活防衛資金、サイドFIREの考え方をまとめています。</p>
          <nav class="tool-nav" aria-label="カテゴリリンク">
            <a href="index.html#top">トップ</a>
            <a href="category-side-business.html">副業</a>
            <a href="category-tax.html">税金</a>
        ...
        <section class="content-panel">
          ...
          <div class="article-list">
            ...
            <a class="article-link" href="index.html#dividend-life">
              <strong>配当生活達成シミュレーター</strong>
              <span>生活費を配当収入だけでまかなう必要資産を確認</span>
            </a>
          </div>
          <h2>関連記事</h2>
