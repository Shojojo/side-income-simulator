...
const seoDescription = "31歳の会社員が長時間労働の合間に、副業、AI活用、固定費改善、新NISA、FIREを検証する実体験型の資産形成メディアです。長時間労働や急な対応がある中でも、次の一手を選びやすい導線を用意しています。 50種類のシミュレーターで収入、支出、投資、税金を確認できます。";
...
const routeSeo = {
  ...
  "side-fire-roadmap": {
    title: "副業FIRE達成ロードマップ診断｜会社員のFIRE戦略を現実診断【2026年版】",
    description: "年齢、年収、副業収入、現在資産、毎月投資額、生活費、想定年利、FIRE目標年齢から、FIRE達成確率と現実的な改善ロードマップを診断します。",
  },
    ...
    <div class="app-shell">
      ...
      <section class="view" data-view="top" aria-label="&#x30b7;&#x30df;&#x30e5;&#x30ec;&#x30fc;&#x30bf;&#x30fc;&#x4e00;&#x89a7;">
        ...
        <section class="article-panel media-intro-panel" aria-label="会社員向け副業・資産形成メディアのコンセプト">
          ...
          <section class="tool-heading">
            <h2>会社員が本業後に進める副業・資産形成メディア</h2>
            <p>このサイトは、シミュレーターを並べただけの便利ツール集ではありません。運送業の管理職として働きながら、副業、AI活用、固定費改善、新NISA、長期投資、FIRE戦略を実際に検証し、会社員が次の一手を選びやすい形に整理しています。</p>
          </section>
          <div class="experience-block">
            <h3>サイトコンセプト</h3>
            <p>運営者は31歳の会社員です。約30名規模の現場管理、人員調整、当日欠勤対応、夜間対応を経験する中で、会社員収入だけに依存する働き方へ不安を感じるようになりました。そこで、本業後の限られた時間でも続けられる副業設計と、固定費改善・投資・FIREをつなげた資産形成を検証しています。</p>
            <p>派手な成功談ではなく、平日1時間しか使えない日、急な欠勤対応で予定が崩れる日、疲れて作業が進まない日も前提にしています。記事とシミュレーターは、収入、税金、生活費、投資、時間をまとめて考えるための入口として作っています。</p>
          </div>
          <div class="media-grid proof-grid">
            <div class="experience-block">
              <h3>運営方針</h3>
              <p>ChatGPTは構成補助として使いますが、体験談、数字の見方、最終確認は運営者自身で行います。税金や制度は公的資料・公式情報を確認し、誤りを見つけた場合は修正します。</p>
            </div>
            <div class="experience-block">
              <h3>このサイトで分かること</h3>
              <p>副業収入、手取り、住民税、AI時短、固定費改善、新NISA、配当投資、FIRE、老後資金まで、会社員が資産形成で迷いやすい数字をまとめて確認できます。</p>
            </div>
            <div class="experience-block">
              <h3>会社員向けである理由</h3>
              <p>本業後の時間は無限ではありません。長時間労働や急なトラブルがあっても続けられるよう、短時間で確認できる計算と、次に読むべき記事への導線を重視しています。</p>
            </div>
            <div class="experience-block">
              <h3>実際に検証していること</h3>
              <p>AIでの作業短縮、本業後1時間副業、固定費削減、NISA積立、長期投資、40歳FIREへ向けた改善順を、自分の働き方に合わせて試しています。</p>
            </div>
            <div class="experience-block">
              <h3>今後の更新予定</h3>
              <p>制度変更、実際に使ったツールの改善点、シミュレーターの入力項目、実録記事を定期的に見直します。単発の情報ではなく、働きながら検証する記録として育てます。</p>
            </div>
          </div>
        </section>
        ...
        <section class="article-panel" aria-label="このサイトでできること">
          ...
          <div class="article-list">
            ...
            <a class="article-link" href="fire.html"><strong>FIRE</strong><span>必要資産、達成年数、生活費改善による短縮効果を確認</span></a>
            <a class="article-link" href="nisa.html"><strong>NISA</strong><span>毎月積立、年利、運用年数から将来資産を確認</span></a>
        ...
        <section class="article-panel" aria-label="初心者向けおすすめツールTOP10">
          ...
          <div class="article-list">
            ...
            <a class="article-link" href="take-home.html"><strong>2. 副業手取り計算シミュレーター</strong><span>売上ではなく、税金後に残る金額を見ます</span></a>
        ...
        <section class="top-search-panel" aria-label="ツール検索">
          ...
          <div class="search-actions" aria-label="よく使う検索">
            ...
            <a href="take-home.html">手取りを確認</a>
            <a href="nisa.html">NISAを試算</a>
            <a href="fire.html">FIREを目指す</a>
          </div>
        </section>
        ...
        <section class="article-panel" aria-label="初心者おすすめ導線">
          ...
          <div class="quick-start-grid">
            <a href="side-income.html">副業を始める</a>
            <a href="ai-efficiency.html">AIで効率化する</a>
            <a href="take-home.html">手取りを知る</a>
            <a href="nisa.html">投資を始める</a>
            <a href="fire.html">FIREを考える</a>
            <a href="retirement.html">老後資金を確認</a>
          </div>
        </section>
        ...
        <section class="article-panel ranking-panel" aria-label="人気ツールランキング">
          ...
          <ol class="ranking-list">
            <li><a href="side-income.html"><strong>副業月収シミュレーター</strong><span>時給、作業時間、案件数から副業収入の入口を確認</span></a></li>
            <li><a href="ai-efficiency.html"><strong>AI副業効率化シミュレーター</strong><span>AI活用後の削減時間、時給、年間追加利益を確認</span></a></li>
            <li><a href="fire.html"><strong>FIRE達成シミュレーター</strong><span>目標資産までの年数と毎月積立の距離感を確認</span></a></li>
            <li><a href="life-cost.html"><strong>生活コスト最適化シミュレーター</strong><span>固定費・変動費の改善余地と投資効果を確認</span></a></li>
            <li><a href="nisa.html"><strong>新NISAシミュレーター</strong><span>毎月積立と年利から将来資産を試算</span></a></li>
          </ol>
        </section>
        ...
        <section class="article-panel" aria-label="FIRE人気カテゴリ">
          ...
          <div class="article-list">
            ...
            <a class="article-link" href="fire-rate.html">
            ...
            <a class="article-link" href="life-cost.html">
        ...
        <section class="article-panel" aria-label="副業人気カテゴリ">
          ...
          <div class="article-list">
            ...
            <a class="article-link" href="ai-efficiency.html">
              <strong>AI副業効率化シミュレーター</strong>
              <span>AI活用で時給と作業時間がどう変わるか確認</span>
            </a>
            <a class="article-link" href="take-home.html">
        ...
        <section class="category-section" aria-label="&#x526f;&#x696d;&#x53ce;&#x76ca;&#x7cfb;">
          ...
          <div class="tool-grid">
          <a class="tool-card" href="side-income.html">
          ...
          <a class="tool-card" href="ai-time-reduction.html">
          ...
          <a class="tool-card" href="ai-outsourcing.html">
          ...
          <a class="tool-card" href="hourly-improvement.html">
          ...
          <a class="tool-card" href="side-time-management.html">
          ...
          <a class="tool-card" href="side-fatigue.html">
          ...
          <a class="tool-card" href="side-profit-margin.html">
        ...
        <section class="category-section" aria-label="&#x7a0e;&#x91d1;&#x7cfb;&#x30c4;&#x30fc;&#x30eb;">
          ...
          <div class="tool-grid">
          <a class="tool-card" href="tax.html">
          ...
          <a class="tool-card" href="employee-tax-saving.html">
          ...
          <a class="tool-card" href="resident-tax.html">
          ...
          <a class="tool-card" href="incorporation.html">
          ...
          <a class="tool-card" href="take-home.html">
        ...
        <section class="category-section" aria-label="FIRE&#x7cfb;&#x30c4;&#x30fc;&#x30eb;">
          ...
          <div class="tool-grid">
          <a class="tool-card" href="investment-risk.html">
            <p class="eyebrow">Risk Check</p>
            <h2>投資リスク許容度診断</h2>
          ...
          <a class="tool-card" href="nisa.html">
          ...
          <a class="tool-card" href="nisa-fast.html">
          ...
          <a class="tool-card" href="nisa-withdrawal.html">
          ...
          <a class="tool-card" href="credit-card-investment.html">
          ...
          <a class="tool-card" href="ideco.html">
          ...
          <a class="tool-card" href="fire-rate.html">
          ...
          <a class="tool-card" href="side-fire-roadmap.html">
            <p class="eyebrow">FIRE Roadmap</p>
            <h2>副業FIRE達成ロードマップ診断</h2>
            <p>年齢、資産、副業収入、投資額、生活費から、FIRE達成までの現実的な改善順を診断します。</p>
            <div class="tool-meta">
              <span>達成確率</span>
              <span>不足額</span>
              <span>改善順位</span>
          ...
          <a class="tool-card" href="fire-cost-optimization.html">
          ...
          <a class="tool-card" href="fire-stress.html">
          ...
          <a class="tool-card" href="cash-flow.html">
          ...
          <a class="tool-card" href="life-cost.html">
          ...
          <a class="tool-card" href="dividend.html">
          ...
          <a class="tool-card" href="dividend-etf.html">
          ...
          <a class="tool-card" href="dividend-stock.html">
          ...
          <a class="tool-card" href="dividend-mental.html">
          ...
          <a class="tool-card" href="dividend-reinvestment.html">
          ...
          <a class="tool-card" href="dividend-life.html">
          ...
          <a class="tool-card" href="dividend-life-years.html">
          ...
          <a class="tool-card" href="side-fire.html">
        ...
        <section class="category-section" aria-label="&#x8001;&#x5f8c;&#x8cc7;&#x91d1;&#x7cfb;">
          ...
          <div class="tool-grid">
          <a class="tool-card" href="emergency-fund.html">
          ...
          <a class="tool-card" href="fixed-cost-reduction.html">
          ...
          <a class="tool-card" href="retirement.html">
          ...
          <a class="tool-card" href="mortgage.html">
        ...
        <section class="article-panel ranking-panel" aria-label="&#x4eba;&#x6c17;&#x30c4;&#x30fc;&#x30eb;">
          ...
          <ol class="ranking-list">
            ...
            <li><a href="nisa.html"><strong>&#x65b0;NISA&#x30fb;&#x7a4d;&#x7acb;&#x6295;&#x8cc7;</strong><span>&#x7a4d;&#x7acb;&#x306e;&#x5c06;&#x6765;&#x984d;&#x3068;&#x904b;&#x7528;&#x76ca;&#x3092;&#x78ba;&#x8a8d;</span></a></li>
            <li><a href="nisa-fast.html"><strong>新NISA最速積立</strong><span>毎月積立とボーナス積立で資産形成速度を確認</span></a></li>
            <li><a href="nisa-withdrawal.html"><strong>NISA取り崩し</strong><span>老後に何年取り崩せるかと毎月使える額を確認</span></a></li>
            <li><a href="credit-card-investment.html"><strong>&#x30af;&#x30ec;&#x30ab;&#x7a4d;&#x7acb;&#x6bd4;&#x8f03;</strong><span>&#x30dd;&#x30a4;&#x30f3;&#x30c8;&#x9084;&#x5143;&#x3068;&#x901a;&#x5e38;&#x7a4d;&#x7acb;&#x306e;&#x5dee;&#x3092;&#x78ba;&#x8a8d;</span></a></li>
            <li><a href="ideco.html"><strong>iDeCo&#x7bc0;&#x7a0e;</strong><span>&#x6bce;&#x6708;&#x306e;&#x639b;&#x91d1;&#x304b;&#x3089;&#x7bc0;&#x7a0e;&#x984d;&#x3068;&#x5c06;&#x6765;&#x8cc7;&#x7523;&#x3092;&#x78ba;&#x8a8d;</span></a></li>
            <li><a href="dividend.html"><strong>&#x914d;&#x5f53;&#x91d1;</strong><span>&#x5e74;&#x9593;&#x914d;&#x5f53;&#x91d1;&#x3068;&#x6708;&#x5e73;&#x5747;&#x914d;&#x5f53;&#x91d1;&#x3092;&#x78ba;&#x8a8d;</span></a></li>
            <li><a href="dividend-etf.html"><strong>配当ETF比較</strong><span>複数ETFの配当収入と資産成長を比較</span></a></li>
            <li><a href="dividend-stock.html"><strong>高配当株比較</strong><span>複数銘柄の配当収入、資産成長、ETFとの違いを比較</span></a></li>
            <li><a href="dividend-mental.html"><strong>配当メンタル安定度診断</strong><span>配当投資を続ける精神安定度と依存リスクを確認</span></a></li>
            <li><a href="dividend-reinvestment.html"><strong>&#x914d;&#x5f53;&#x518d;&#x6295;&#x8cc7;</strong><span>&#x914d;&#x5f53;&#x3092;&#x518d;&#x6295;&#x8cc7;&#x3057;&#x305f;&#x5834;&#x5408;&#x306e;&#x8cc7;&#x7523;&#x6210;&#x9577;&#x3092;&#x78ba;&#x8a8d;</span></a></li>
            <li><a href="dividend-life.html"><strong>配当生活達成</strong><span>生活費を配当収入だけでまかなう必要資産を確認</span></a></li>
            <li><a href="dividend-life-years.html"><strong>配当生活年数</strong><span>現在資産と生活費から配当生活の継続年数を確認</span></a></li>
            <li><a href="fire.html"><strong>FIRE&#x9054;&#x6210;</strong><span>&#x76ee;&#x6a19;&#x8cc7;&#x7523;&#x307e;&#x3067;&#x306e;&#x5e74;&#x6570;&#x3092;&#x78ba;&#x8a8d;</span></a></li>
            <li><a href="fire-rate.html"><strong>FIRE達成率</strong><span>現在資産、収支、投資状況からFIRE可能性をスコア化</span></a></li>
      ...
      <section class="view" data-view="nisa-fast" aria-label="新NISA最速積立シミュレーター">
        ...
        <section class="article-panel" aria-label="新NISA最速積立関連ツール">
          ...
          <div class="related-links">
            <a href="nisa.html">新NISAシミュレーター</a>
            <a href="dividend-reinvestment.html">配当再投資シミュレーター</a>
            <a href="fire.html">FIRE達成シミュレーター</a>
          </div>
        </section>
      ...
      <section class="view" data-view="side-fire-roadmap" aria-label="副業FIRE達成ロードマップ診断">
        <section class="tool-heading">
          <h2>副業FIRE達成ロードマップ診断</h2>
          <p>年齢、年収、副業収入、現在資産、毎月投資額、生活費、想定年利、FIRE目標年齢から、FIRE達成までの現実的なロードマップを診断します。</p>
        </section>

        <section class="workspace" aria-label="副業FIREロードマップの診断">
          <form class="input-panel" id="sideFireRoadmapForm">
            <div class="field">
              <label for="roadmapAge">年齢 <span class="unit">歳</span></label>
              <input id="roadmapAge" name="roadmapAge" type="number" inputmode="numeric" min="0" max="100" step="1" value="31" required aria-describedby="roadmapAgeError">
              <p class="error" id="roadmapAgeError"></p>
            </div>
            <div class="field">
              <label for="roadmapIncome">年収 <span class="unit">円 / 年</span></label>
              <input id="roadmapIncome" name="roadmapIncome" type="number" inputmode="numeric" min="0" max="1000000000" step="100000" value="5000000" required aria-describedby="roadmapIncomeError">
              <p class="error" id="roadmapIncomeError"></p>
            </div>
            <div class="field">
              <label for="roadmapSideIncome">副業収入 <span class="unit">円 / 月</span></label>
              <input id="roadmapSideIncome" name="roadmapSideIncome" type="number" inputmode="numeric" min="0" max="100000000" step="10000" value="50000" required aria-describedby="roadmapSideIncomeError">
              <p class="error" id="roadmapSideIncomeError"></p>
            </div>
            <div class="field">
              <label for="roadmapAssets">現在資産 <span class="unit">円</span></label>
              <input id="roadmapAssets" name="roadmapAssets" type="number" inputmode="numeric" min="0" max="10000000000" step="100000" value="5000000" required aria-describedby="roadmapAssetsError">
              <p class="error" id="roadmapAssetsError"></p>
            </div>
            <div class="field">
              <label for="roadmapMonthlyInvestment">毎月投資額 <span class="unit">円 / 月</span></label>
              <input id="roadmapMonthlyInvestment" name="roadmapMonthlyInvestment" type="number" inputmode="numeric" min="0" max="100000000" step="10000" value="100000" required aria-describedby="roadmapMonthlyInvestmentError">
              <p class="error" id="roadmapMonthlyInvestmentError"></p>
            </div>
            <div class="field">
              <label for="roadmapLivingCost">生活費 <span class="unit">円 / 月</span></label>
              <input id="roadmapLivingCost" name="roadmapLivingCost" type="number" inputmode="numeric" min="1" max="100000000" step="10000" value="250000" required aria-describedby="roadmapLivingCostError">
              <p class="error" id="roadmapLivingCostError"></p>
            </div>
            <div class="field">
              <label for="roadmapReturn">想定年利 <span class="unit">%</span></label>
              <input id="roadmapReturn" name="roadmapReturn" type="number" inputmode="decimal" min="0" max="30" step="0.1" value="5" required aria-describedby="roadmapReturnError">
              <p class="error" id="roadmapReturnError"></p>
            </div>
            <div class="field">
              <label for="roadmapTargetAge">FIRE目標年齢 <span class="unit">歳</span></label>
              <input id="roadmapTargetAge" name="roadmapTargetAge" type="number" inputmode="numeric" min="1" max="100" step="1" value="40" required aria-describedby="roadmapTargetAgeError">
              <p class="error" id="roadmapTargetAgeError"></p>
            </div>
            <div class="actions">
              <button type="reset">リセット</button>
            </div>
          ...
          <section class="result-panel" aria-live="polite">
            <div class="hero-result">
              <p class="eyebrow">FIRE達成確率</p>
              <p class="amount" id="roadmapProbability">0%</p>
            </div>
            <p class="notice" id="roadmapNotice">入力を確認してください。目標年齢は現在年齢より大きくしてください。</p>
            <div class="result-grid">
              <div class="metric">
                <strong>達成予想年齢</strong>
                <span class="accent-green" id="roadmapAchieveAge">0歳</span>
                <small>現在資産、副業収入、投資額で目標資産へ届く年齢</small>
              </div>
              <div class="metric">
                <strong>不足額</strong>
                <span class="accent-amber" id="roadmapShortage">0円</span>
                <small>FIRE目標年齢時点で不足する資産額</small>
              </div>
              <div class="metric">
                <strong>必要副業収入</strong>
                <span class="accent-blue" id="roadmapRequiredSideIncome">0円</span>
                <small>目標年齢までに不足を埋める月額副業収入の目安</small>
              </div>
              <div class="metric">
                <strong>改善優先順位</strong>
                <span class="accent-green text-metric" id="roadmapPriority">入力を確認してください</span>
                <small>副業、投資、生活費、年利のどこから整えるか</small>
              </div>
              <div class="metric">
                <strong>おすすめ関連ツール</strong>
                <span class="accent-amber text-metric" id="roadmapRelatedTools">FIRE達成率、生活費最適化、会社員FIRE年数</span>
                <small>次に確認したいシミュレーター</small>
              </div>
            </div>
          </section>
        ...
        <section class="faq-panel" aria-label="副業FIRE達成ロードマップFAQ">
          <h3>FAQ</h3>
          <div class="faq-list">
            <details>
              <summary>FIRE達成確率は何を表していますか？</summary>
              <p>目標FIRE年齢時点の予想資産が、生活費25年分のFIRE必要資産にどれくらい近いかを示す簡易スコアです。投資成果を保証するものではなく、改善順を決めるための目安です。</p>
            </details>
            <details>
              <summary>副業収入はすべて投資に回す前提ですか？</summary>
              <p>この診断では、副業収入をFIREに向けた追加投資余力として扱います。実際には税金や経費もあるため、副業手取りや副業税金シミュレーターと合わせて見ると現実に近づきます。</p>
            </details>
            <details>
              <summary>目標年齢に届かない場合は何から改善すべきですか？</summary>
              <p>まず生活費を下げると必要資産そのものが下がります。次に副業収入、毎月投資額、投資の継続性を整えると、無理なく達成確率を上げやすくなります。</p>
            </details>
            <details>
              <summary>会社員でも副業FIREは現実的ですか？</summary>
              <p>本業後の時間が限られるため簡単ではありませんが、副業収入、固定費改善、新NISA、長期投資を組み合わせると現実的なロードマップを作りやすくなります。</p>
            </details>
          </div>
        </section>
          ...
          <section class="result-panel" aria-live="polite">
            ...
            <div class="result-grid">
              ...
              <div class="metric">
                ...
                <small><a href="fixed-cost-reduction.html">固定費削減シミュレーターへ進む</a></small>
              </div>
            </div>
          </section>
        </section>
      ...
      <footer class="site-footer">
        <nav class="footer-links" aria-label="&#x30b5;&#x30a4;&#x30c8;&#x60c5;&#x5831;">
          ...
          <a href="nisa-fast.html">新NISA最速積立</a>
          <a href="nisa-withdrawal.html">NISA取り崩し</a>
          <a href="credit-card-investment.html">&#x30af;&#x30ec;&#x30ab;&#x7a4d;&#x7acb;</a>
          <a href="ideco.html">iDeCo&#x7bc0;&#x7a0e;</a>
          <a href="dividend.html">&#x914d;&#x5f53;&#x91d1;</a>
          <a href="dividend-stock.html">高配当株比較</a>
          <a href="dividend-mental.html">配当メンタル</a>
          <a href="dividend-reinvestment.html">&#x914d;&#x5f53;&#x518d;&#x6295;&#x8cc7;</a>
          <a href="dividend-life.html">配当生活達成</a>
          <a href="dividend-life-years.html">配当生活年数</a>
          <a href="fire.html">FIRE&#x9054;&#x6210;</a>
...
function insertLastUpdatedDates() {
  const routeDates = {
    ...
    "side-continuity": "2026年6月30日",
    "side-motivation": "2026年6月30日",
    "side-risk": "2026年6月30日",
    "side-safety": "2026年6月30日",
    "hourly-improvement": "2026年6月30日",
    "side-profit-margin": "2026年6月30日",
    "incorporation": "2026年6月30日",
    "tax": "2026年6月30日",
    ...
    "fire-stress": "2026年6月30日",
    "employee-fire": "2026年6月30日",
    ...
    "dividend-mental": "2026年6月30日",
    "dividend-reinvestment": "2026年6月30日",
    "dividend-life": "2026年6月30日",
    "dividend-life-years": "2026年6月30日",
    "nisa-withdrawal": "2026年6月30日",
    "credit-card-investment": "2026年6月30日",
    "side-fire": "2026年6月30日",
    "mortgage": "2026年6月30日",
  };
...
const suitedUsers = {
  ...
  "side-continuity": "副業を始めたものの続けられるか不安な人に向いています。副業時間、疲労度、収益、目標月収を見ながら、挫折リスクや改善ポイントを知りたい副業初心者や会社員に役立ちます。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "side-motivation": "副業のやる気が続くか不安な人、目標と現実の差を確認したい人に向いています。本業後の疲労や睡眠、趣味時間も含めて、無理なくモチベーションを保つ方法を考えたい会社員向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "side-risk": "副業の税務、疲労、収益依存リスクをまとめて確認したい会社員に向いています。副業収入が増えてきた人や、確定申告、睡眠不足、収益の偏りが気になり始めた人に使いやすいです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "side-safety": "会社員として安全に副業を続けたい人に向いています。会社規定、普通徴収、確定申告、匿名性、作業時間をまとめて見て、会社バレや税務、疲労リスクを下げたい人に役立ちます。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "hourly-improvement": "副業の実質時給を上げたい人、作業時間の割に利益が残っていないと感じる人に向いています。AI活用や外注費の見直しで、目標時給に近づける改善ポイントを知りたい会社員向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "side-profit-margin": "副業売上はあるのに利益が残らない人、広告費や外注費を含めて効率を見たい人に向いています。利益率、時給換算、AI活用の改善効果を確認したい副業初心者にも使いやすいです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "incorporation": "副業利益が増えて法人化を考え始めた人に向いています。個人事業と法人化の手取り差、維持費、税率、社会保険負担を比較し、今すぐ法人化すべきか冷静に見たい人向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "tax": "副業収入が出始め、税金や青色申告の影響を知りたい会社員に向いています。売上、経費、控除を入れて手取り感を確認し、確定申告前に納税資金を準備したい人に役立ちます。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "employee-tax-saving": "会社員として使える節税方法を整理したい人に向いています。iDeCo、ふるさと納税、保険控除、副業所得の影響をまとめて見て、手取り改善とFIRE準備を両立したい人に使いやすいです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "income-tax": "副業所得にかかる所得税を概算したい会社員に向いています。売上、経費、控除、税率を入れて、所得税と復興特別所得税、月平均負担を早めに確認したい人に役立ちます。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "resident-tax": "副業の住民税負担や普通徴収の注意点を確認したい会社員に向いています。副業所得、青色申告控除、均等割を入れて、翌年の住民税負担を見込んでおきたい人に使いやすいです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "take-home": "副業の売上から税金や経費を引いた手取りを知りたい人に向いています。月収目標だけで判断せず、実際に残る金額を見て、生活費や投資に回せる余力を確認したい会社員向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "investment-risk": "投資を始めたいけれど、自分に合うリスク量が分からない人に向いています。年齢、資産、投資経験、暴落時の行動を見ながら、インデックス、高配当、FIRE向きの投資スタイルを考えたい人向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "nisa": "新NISAで長期投資を始めたい初心者や会社員に向いています。毎月積立、年利、運用年数から将来資産を見て、副業収入や固定費削減分を投資に回すイメージを作りたい人に役立ちます。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "nisa-fast": "新NISAでできるだけ早く資産形成したい人に向いています。毎月積立とボーナス積立、成長投資枠の活用を含めて、目標資産までの速度やFIREへの影響を見たい人に使いやすいです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "ideco": "iDeCoの節税効果と将来資産を知りたい会社員に向いています。掛金による所得税、住民税の軽減額を見ながら、老後資金づくりとFIRE戦略にどう組み込むか考えたい人向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "fire": "FIREを目指したい会社員や投資初心者に向いています。現在資産、毎月積立、生活費、副業収入から必要資産と達成時期を見て、固定費改善や副業をどこまで伸ばすべきか考えたい人向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "fire-rate": "FIRE達成の可能性をスコアで見たい人に向いています。資産、積立、副業収入、配当、生活費をまとめて入力し、今のまま進めるか、何を優先して改善すべきか確認したい会社員向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "side-fire-roadmap": "副業収入を使ってFIREまでの道筋を作りたい人に向いています。年齢、資産、投資額、生活費をもとに、達成予想年齢や不足額、必要な副業収入を見たい会社員に使いやすいです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "fire-cost-optimization": "生活費を下げることでFIRE時期を早めたい人に向いています。固定費削減、追加投資、副業収入の効果をまとめて見て、収入を増やす前に支出改善でどれだけ変わるか知りたい人向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "fire-stress": "FIRE後の生活や収入不安が気になる人に向いています。資産額だけでなく、副業収入、配当、仕事ストレス、孤独耐性、趣味の有無を見て、サイドFIREも含めた現実的な準備を考えたい人向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "employee-fire": "会社員としてFIREまでの年数を知りたい人に向いています。現在資産、積立、副業月収、配当収入を入力し、本業を続けながら何年で目標資産に近づけるか確認したい人に使いやすいです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "cash-flow": "毎月の収支と投資可能額を整理したい会社員に向いています。給与、副業収入、家賃、食費、ローン返済をまとめて見て、FIREや生活防衛資金づくりに回せる余力を知りたい人向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "life-cost": "生活費全体を見直し、固定費と変動費の改善余地を知りたい人に向いています。副業収入や投資額も含めて、毎月の生活コストが資産形成とFIREにどう影響するか見たい会社員向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "emergency-fund": "生活防衛資金をいくら用意すべきか知りたい人に向いています。家族人数、雇用形態、失業時の想定期間をもとに、FIREや投資を始める前の安全資金を確認したい会社員向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "fixed-cost-reduction": "固定費を下げて投資や副業に回す余力を作りたい人に向いています。通信費、保険、サブスク、家賃などを見直し、年間節約額や将来資産への効果を知りたい会社員に役立ちます。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "retirement": "老後資金が足りるか不安な会社員や投資初心者に向いています。現在年齢、貯蓄、積立、年金見込みから退職時資産や不足額を見て、NISAやiDeCoと組み合わせた準備を考えたい人向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "education": "子どもの教育費を早めに把握したい家庭に向いています。公立、私立、大学進学の有無をもとに必要額と不足額を見て、老後資金や毎月積立とのバランスを考えたい会社員に役立ちます。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "education-insurance": "学資保険と通常の積立投資を比較したい人に向いています。返戻率、利回り、積立年数から将来受取額を見て、教育費準備と老後資金への影響を同時に確認したい家庭向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "dividend": "配当金で毎月の収入を少しずつ増やしたい投資初心者に向いています。投資額、利回り、保有年数から年間配当や累計配当を見て、FIREや新NISA活用のイメージを作りたい人向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "dividend-etf": "高配当ETFを比較しながら配当収入を増やしたい人に向いています。ETF別の利回り、成長率、NISA利用を見て、分散投資でFIREや配当生活を目指したい投資初心者に使いやすいです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "dividend-stock": "高配当株とETFの違いを見ながら投資したい人に向いています。銘柄別の配当、成長率、再投資効果を確認し、FIREや配当生活に向けた投資スタイルを考えたい人向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "dividend-mental": "高配当投資を続ける精神的な安定度を知りたい人に向いています。暴落耐性、現金比率、配当依存度を見て、FIRE後も慌てず保有を続けられるか確認したい投資家向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "dividend-reinvestment": "配当を再投資して資産成長を加速したい人に向いています。配当利回り、株価成長率、追加投資を入れて、再投資ありなしの差やFIRE達成への影響を確認したい人向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "dividend-life": "生活費を配当収入でまかなう目標を持つ人に向いています。必要資産、年間必要配当金、達成予想年を見て、FIREや新NISAを使った配当生活の現実度を確認したい人向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "dividend-life-years": "現在資産と配当利回りで、配当生活を何年続けられるか知りたい人に向いています。インフレや運用継続も含めて、FIRE後の継続可能性を見たい投資初心者に使いやすいです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "nisa-withdrawal": "新NISA資産を将来どう取り崩すか考えたい人に向いています。毎月取り崩し額や運用継続の有無から、資産が何年持つか、老後資金やFIREにどう影響するか確認できます。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "credit-card-investment": "クレカ積立のポイント還元を投資に活かしたい人に向いています。通常積立との最終資産差、累計ポイント、再投資効果を見て、新NISAやFIRE準備にどれくらい効くか知りたい人向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "side-fire": "完全FIREではなく、副業収入も残して早めに自由度を上げたい人に向いています。生活費、副業月収、配当収入を入れて、必要資産や不足額、老後資金とのバランスを見たい会社員向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。",
  "mortgage": "住宅ローンの返済額と老後資金への影響を見たい人に向いています。借入額、金利、返済年数、繰上返済を入れて、毎月返済額や総返済額、年収に対する負担感を確認したい家庭向けです。入力前に、自分の目的と優先順位を確認する入口として使ってください。"
};

function insertSuitedUsersSections() {
  Object.entries(suitedUsers).forEach(([route, text]) => {
    const view = document.querySelector('[data-view="' + route + '"]');
    if (!view || view.querySelector(".suited-users")) {
      return;
    }
...
const routeExperienceProfiles = {
  ...
  "ai-profit-max": { title: "AI副業利益最大化シミュレーター", kind: "ai", reason: "AIを副業に入れるなら、時短だけで終わらせず、利益率、時給、目標月収までの距離まで見たいと感じて作りました。本業後の限られた時間では、浮いた時間をどの作業に回すかで収益の伸び方が変わります。", use: "AI導入後の利益額とROIを見て、ツール費用を増やす価値があるか判断してください。利益改善が小さい場合は、調査、下書き、テンプレ化など低リスクな作業から試し、浮いた時間を営業や高単価作業へ回す設計にしましょう。", articles: [["副業向けおすすめAIツール比較", "article-ai-tools-comparison.html"], ["副業効率化おすすめAIツール比較", "article-ai-side-business.html"], ["副業利益率シミュレーター", "side-profit-margin.html"]] },
...
const relatedToolGroups = {
  ...
  investment: [
    ["投資リスク許容度診断", "investment-risk.html"],
    ["新NISAシミュレーター", "nisa.html"],
    ["新NISA最速積立シミュレーター", "nisa-fast.html"],
    ["iDeCo節税シミュレーター", "ideco.html"],
    ["配当金シミュレーター", "dividend.html"],
    ["高配当株比較シミュレーター", "dividend-stock.html"],
    ["配当メンタル安定度診断", "dividend-mental.html"],
    ["配当生活年数シミュレーター", "dividend-life-years.html"],
    ["クレカ積立比較シミュレーター", "credit-card-investment.html"],
  ],
  fire: [
    ["FIRE達成シミュレーター", "fire.html"],
    ["FIRE達成率シミュレーター", "fire-rate.html"],
  ...
  household: [
    ["FIRE生活費最適化シミュレーター", "fire-cost-optimization.html"],
    ["会社員キャッシュフローシミュレーター", "cash-flow.html"],
    ["生活コスト最適化シミュレーター", "life-cost.html"],
    ["固定費削減シミュレーター", "fixed-cost-reduction.html"],
    ["生活防衛資金シミュレーター", "emergency-fund.html"],
...
const nextReadFlows = {
  side: [
    ...
    {
      title: "固定費削減シミュレーター",
      href: "fixed-cost-reduction.html",
...
const fieldRules = {
  ...
  roadmapAge: { label: "年齢", min: 0, max: 100, unit: "歳", integer: true },
  roadmapIncome: { label: "年収", min: 0, max: 1000000000, unit: "円", integer: false },
  roadmapSideIncome: { label: "副業収入", min: 0, max: 100000000, unit: "円", integer: false },
  roadmapAssets: { label: "現在資産", min: 0, max: 10000000000, unit: "円", integer: false },
  roadmapMonthlyInvestment: { label: "毎月投資額", min: 0, max: 100000000, unit: "円", integer: false },
  roadmapLivingCost: { label: "生活費", min: 1, max: 100000000, unit: "円", integer: false },
  roadmapReturn: { label: "想定年利", min: 0, max: 30, unit: "%", integer: false },
  roadmapTargetAge: { label: "FIRE目標年齢", min: 1, max: 100, unit: "歳", integer: true },
...
function renderSideFireRoadmap() {
  const values = {
    roadmapAge: getFieldValue("roadmapAge"),
    roadmapIncome: getFieldValue("roadmapIncome"),
    roadmapSideIncome: getFieldValue("roadmapSideIncome"),
    roadmapAssets: getFieldValue("roadmapAssets"),
    roadmapMonthlyInvestment: getFieldValue("roadmapMonthlyInvestment"),
    roadmapLivingCost: getFieldValue("roadmapLivingCost"),
    roadmapReturn: getFieldValue("roadmapReturn"),
    roadmapTargetAge: getFieldValue("roadmapTargetAge"),
  };
  let hasError = Object.values(values).some((item) => !item.valid);

  if (values.roadmapAge.valid && values.roadmapTargetAge.valid && values.roadmapTargetAge.value <= values.roadmapAge.value) {
    const input = document.querySelector("#roadmapTargetAge");
    const error = document.querySelector("#roadmapTargetAgeError");
    input.setAttribute("aria-invalid", "true");
    error.textContent = "FIRE目標年齢は現在の年齢より大きくしてください。";
    hasError = true;
  }

  document.querySelector("#roadmapNotice").classList.toggle("is-visible", hasError);
  if (hasError) {
    setText("roadmapProbability", "入力エラー");
    setText("roadmapAchieveAge", "入力エラー");
    setText("roadmapShortage", yen.format(0));
    setText("roadmapRequiredSideIncome", yen.format(0));
    setText("roadmapPriority", "入力内容を確認してください");
    setText("roadmapRelatedTools", "FIRE達成率、生活費最適化、会社員FIRE年数");
    return;
  }

  const age = values.roadmapAge.value;
  const income = values.roadmapIncome.value;
  const sideIncome = values.roadmapSideIncome.value;
  const currentAssets = values.roadmapAssets.value;
  const monthlyInvestment = values.roadmapMonthlyInvestment.value;
  const monthlyCost = values.roadmapLivingCost.value;
  const annualReturn = values.roadmapReturn.value;
  const targetAge = values.roadmapTargetAge.value;
  const annualCost = monthlyCost * 12;
  const fireTarget = annualCost * 25;
  const monthsToTarget = Math.max((targetAge - age) * 12, 1);
  const monthlyTotal = monthlyInvestment + sideIncome;
  const projectedAtTarget = calculateFutureAssets(currentAssets, monthlyTotal, annualReturn, monthsToTarget);
  const shortage = Math.max(fireTarget - projectedAtTarget, 0);
  const probability = Math.max(0, Math.min(100, Math.round((projectedAtTarget / fireTarget) * 100)));
  const achievementMonths = findAchievementMonths(currentAssets, monthlyTotal, annualReturn, fireTarget);
  const achieveAge = achievementMonths === null ? "未達成" : `${age + Math.ceil(achievementMonths / 12)}歳`;
  const requiredAdditionalMonthly = calculateRequiredMonthly(currentAssets, monthlyTotal, annualReturn, monthsToTarget, fireTarget);
  const requiredSideIncome = Math.max(requiredAdditionalMonthly, 0);
  const investmentRate = monthlyTotal / Math.max(income / 12 + sideIncome, 1);
  const costRatio = annualCost / Math.max(income + sideIncome * 12, 1);
  const priority = shortage === 0
    ? "目標年齢時点では達成圏内です。生活防衛資金と税金分を残し、投資を止めない仕組みを優先しましょう。"
    : costRatio >= 0.6
      ? "優先順位は 1.生活費最適化 2.副業収入 3.毎月投資額 です。まず固定費を下げると必要資産も下がります。"
      : sideIncome < 50000
        ? "優先順位は 1.副業月5万円 2.投資自動化 3.新NISA活用 です。本業後1時間で積み上がる作業設計を作りましょう。"
        : investmentRate < 0.25
          ? "優先順位は 1.毎月投資額 2.固定費削減 3.配当再投資 です。収入を投資へ回す比率を上げると改善しやすいです。"
          : "優先順位は 1.継続性 2.リスク許容度 3.生活防衛資金 です。無理に増やすより止めない設計を優先しましょう。";
  const relatedTools = probability >= 80
    ? "FIREストレス診断、NISA取り崩し、配当生活年数で達成後を確認"
    : costRatio >= 0.6
      ? "FIRE生活費最適化、固定費削減、会社員キャッシュフローを確認"
      : sideIncome < 50000
        ? "副業月収、AI副業効率化、副業手取り計算を確認"
        : "FIRE達成率、会社員FIRE年数、サイドFIREを確認";

  setText("roadmapProbability", `${probability}%`);
  setText("roadmapAchieveAge", achieveAge);
  setText("roadmapShortage", yen.format(shortage));
  setText("roadmapRequiredSideIncome", yen.format(requiredSideIncome));
  setText("roadmapPriority", priority);
  setText("roadmapRelatedTools", relatedTools);
}
...
const nextStepConfigs = {
  "side-income": [
    [
      "次の一手",
      "手取りを確認する",
      "副業収入が見えても、経費や税金を引いた後に残る金額は変わります。",
      "副業手取り計算シミュレーター",
      "take-home.html",
      "手取りを確認する",
      "side-income-to-take-home"
    ],
    [
      "税金確認",
      "税金の目安を先に分ける",
      "売上が増えるほど、納税用に残す金額を早めに把握しておくと安心です。",
      "副業税金シミュレーター",
      "tax.html",
      "税金を確認する",
      "side-income-to-tax"
    ...
    [
      "家計へ接続",
      "毎月のお金の流れを見る",
      "副業収入を生活費、貯蓄、投資へどう回せるかを確認します。",
      "キャッシュフローシミュレーター",
      "cash-flow.html",
      "家計を確認する",
      "side-income-to-cash-flow"
    ]
  ],
  "ai-hourly": [
    [
      "収入へ接続",
      "副業収入の現実感を見る",
      "AIで短縮できる時間を、実際の副業月収にどうつなげるか確認します。",
      "副業月収シミュレーター",
      "side-income.html",
      "月収を確認する",
      "ai-hourly-to-side-income"
    ],
    [
      "効率確認",
      "時給改善を確認する",
      "作業時間が減った後、実質時給がどれくらい変わるかを見ます。",
      "副業時給改善シミュレーター",
      "hourly-improvement.html",
      "時給を確認する",
      "ai-hourly-to-hourly-improvement"
    ],
    [
      "手取り確認",
      "残る金額を見る",
      "売上が増えても、経費や税金を引いた後の手取りで判断します。",
      "副業手取り計算シミュレーター",
      "take-home.html",
      "手取りを見る",
      "ai-hourly-to-take-home"
    ]
  ],
  "ai-efficiency": [
    [
    ...
    [
      ...
      "hourly-improvement.html",
      "時給を確認する",
      "ai-efficiency-to-hourly-improvement"
    ],
    [
      "手取り確認",
      "残る金額を見る",
  ...
  "ai-automation": [
    ...
    [
      ...
      "hourly-improvement.html",
      "時給を確認する",
      "ai-automation-to-hourly-improvement"
    ],
    [
      "手取り確認",
      "残る金額を見る",
  ...
  "ai-time-reduction": [
    [
      ...
      "side-income.html",
      "月収を確認する",
      "ai-time-reduction-to-side-income"
    ],
    [
      "効率確認",
      "時給改善を確認する",
      ...
      "hourly-improvement.html",
      "時給を確認する",
      "ai-time-reduction-to-hourly-improvement"
    ],
    [
      "手取り確認",
      "残る金額を見る",
      ...
      "take-home.html",
      "手取りを見る",
      "ai-time-reduction-to-take-home"
    ]
  ],
  "ai-outsourcing": [
    [
    ...
    [
      ...
      "hourly-improvement.html",
      "時給を確認する",
      "ai-outsourcing-to-hourly-improvement"
    ],
    [
      "手取り確認",
      "残る金額を見る",
  ...
  "ai-profit-max": [
    ...
    [
      ...
      "hourly-improvement.html",
      "時給を確認する",
      "ai-profit-max-to-hourly-improvement"
    ],
    [
      "手取り確認",
      "残る金額を見る",
  ...
  "hourly-improvement": [
    [
      "次の一手",
      "手取りを確認する",
      "副業の改善余地が見えたら、最終的に残る金額も確認します。",
      "副業手取り計算シミュレーター",
      "take-home.html",
      "手取りを見る",
      "hourly-improvement-to-take-home"
    ],
    [
      "税金確認",
      "税金の目安を見る",
      "副業が続くほど、所得税や住民税の準備も必要になります。",
      "副業税金シミュレーター",
      "tax.html",
      "税金を見る",
      "hourly-improvement-to-tax"
    ],
    [
      "家計へ接続",
      "毎月の収支に入れる",
      "副業収入を家計全体へ入れると、貯蓄や投資に回せる金額が見えます。",
      "キャッシュフローシミュレーター",
      "cash-flow.html",
      "収支を見る",
      "hourly-improvement-to-cash-flow"
    ]
  ],
  "side-time-management": [
    [
      ...
      "take-home.html",
      "手取りを見る",
      "side-time-management-to-take-home"
    ],
    [
      "税金確認",
      "税金の目安を見る",
    ...
    [
      ...
      "cash-flow.html",
      "収支を見る",
      "side-time-management-to-cash-flow"
    ]
  ],
  "side-fatigue": [
    [
  ...
  "side-profit-margin": [
    [
      ...
      "take-home.html",
      "手取りを見る",
      "side-profit-margin-to-take-home"
    ],
    [
      "税金確認",
      "税金の目安を見る",
    ...
    [
      ...
      "cash-flow.html",
      "収支を見る",
      "side-profit-margin-to-cash-flow"
    ]
  ],
  "incorporation": [
    [
      "次の一手",
      "手取りを確認する",
      "税金や控除を見た後は、実際に残る金額で判断すると使い道を決めやすくなります。",
      "副業手取り計算シミュレーター",
      "take-home.html",
      "手取りを見る",
      "incorporation-to-take-home"
    ],
    [
      "家計へ接続",
      "納税後の収支を見る",
      "納税用資金を分けたうえで、毎月いくら残せるかを確認します。",
      "キャッシュフローシミュレーター",
      "cash-flow.html",
      "収支を見る",
      "incorporation-to-cash-flow"
    ],
    [
      "資産形成",
      "NISA積立へつなげる",
      "手元に残る金額が見えたら、長期積立に回せる余力を確認します。",
      "新NISAシミュレーター",
      "nisa.html",
      "NISAを見る",
      "incorporation-to-nisa"
    ]
  ],
  "take-home": [
    [
      "次の一手",
      "税金の内訳を確認する",
      "手取りが減る理由を所得税・住民税に分けて見ると、納税準備がしやすくなります。",
      "副業税金シミュレーター",
      "tax.html",
      "税金を確認する",
      "take-home-to-tax"
    ...
    [
      "家計へ接続",
      "残ったお金の使い道を整理する",
      "手取りを生活費、貯蓄、投資へどう配分できるかを確認します。",
      "キャッシュフローシミュレーター",
      "cash-flow.html",
      "収支を確認する",
      "take-home-to-cash-flow"
    ],
    [
      "資産形成",
      "手取りを積立へつなげる",
      "毎月残せる金額が見えたら、NISA積立へ回せる余力も確認できます。",
      "新NISAシミュレーター",
      "nisa.html",
      "NISAを試算する",
      "take-home-to-nisa"
  ...
  "tax": [
    [
      "次の一手",
      "税引後に残る金額を見る",
      "税額だけでなく、最終的に使える副業手取りを確認すると判断しやすくなります。",
      "副業手取り計算シミュレーター",
      "take-home.html",
      "手取りを確認する",
      "tax-to-take-home"
  ...
  "employee-tax-saving": [
    [
      ...
      "take-home.html",
      "手取りを見る",
      "employee-tax-saving-to-take-home"
    ],
    [
      "家計へ接続",
      "納税後の収支を見る",
      ...
      "cash-flow.html",
      "収支を見る",
      "employee-tax-saving-to-cash-flow"
    ],
    [
      "資産形成",
      "NISA積立へつなげる",
  ...
  "investment-risk": [
    [
      "次の一手",
      "FIREまでの距離を見る",
      "投資の前提が見えたら、目標資産までの不足額も確認できます。",
      "FIRE達成シミュレーター",
      "fire.html",
      "FIREを見る",
      "investment-risk-to-fire"
    ],
    [
      "老後へ接続",
      "老後資金を確認する",
      "投資を老後資金づくりに使う場合、不足額と準備期間も見ます。",
      "老後資金シミュレーター",
      "retirement.html",
      "老後資金を見る",
      "investment-risk-to-retirement"
    ],
    [
      "配当確認",
      "配当収入の目安を見る",
      "資産形成を現金収入にもつなげたい場合、配当額の目安を確認できます。",
      "配当金シミュレーター",
      "dividend.html",
      "配当を見る",
      "investment-risk-to-dividend"
    ]
  ],
  "nisa": [
    [
      "次の一手",
      "FIREまでの距離を見る",
      "積立額と将来資産が見えたら、目標資産までの不足額も確認できます。",
      "FIRE達成シミュレーター",
      "fire.html",
      "FIREを試算する",
      "nisa-to-fire"
    ...
    [
      "老後へ接続",
      "老後資金の不足額を確認する",
      "NISA積立を老後資金づくりに使う場合、退職後の不足額も合わせて見ます。",
      "老後資金シミュレーター",
      "retirement.html",
      "老後資金を見る",
      "nisa-to-retirement"
    ...
    [
      "実体験",
      "なぜ資産形成を続けるのか読む",
      "運営者がFIREを目指しながらサイトを改善している記録へ進めます。",
      "Project FIRE",
      "project-fire.html",
      "Project FIREを読む",
      "nisa-to-project-fire"
    ]
  ],
  "nisa-fast": [
    [
  ...
  "credit-card-investment": [
    [
      ...
      "fire.html",
      "FIREを見る",
      "credit-card-investment-to-fire"
    ],
    [
      "老後へ接続",
      "老後資金を確認する",
      ...
      "retirement.html",
      "老後資金を見る",
      "credit-card-investment-to-retirement"
    ],
    [
      "配当確認",
      "配当収入の目安を見る",
      ...
      "dividend.html",
      "配当を見る",
      "credit-card-investment-to-dividend"
    ]
  ],
  "ideco": [
    [
  ...
  "fire": [
    [
      "次の一手",
      "挑戦の背景を読む",
      "FIREを数字だけで終わらせず、会社員が実際に改善している過程を確認できます。",
      "Project FIRE",
      "project-fire.html",
      "Project FIREを読む",
      "fire-to-project-fire"
    ],
    [
      "積立確認",
      "NISAで積み立てた場合を見る",
      "FIREに必要な資産づくりを、毎月積立と長期運用の数字で確認します。",
      "新NISAシミュレーター",
      "nisa.html",
      "NISAを試算する",
      "fire-to-nisa"
    ...
    [
      "改善余地",
      "固定費を下げた場合を見る",
      "生活費が下がると必要資産も変わるため、固定費改善の効果を確認します。",
      "固定費削減シミュレーター",
      "fixed-cost-reduction.html",
      "固定費を見る",
      "fire-to-fixed-cost-reduction"
    ]
  ],
  "fire-rate": [
    [
    ...
    [
      ...
      "fixed-cost-reduction.html",
      "固定費を見る",
      "fire-rate-to-fixed-cost-reduction"
    ]
  ],
  "side-fire-roadmap": [
    [
      ...
      "project-fire.html",
      "記録を読む",
      "side-fire-roadmap-to-project-fire"
    ],
    [
      "投資確認",
      "NISA積立を確認する",
    ...
    [
      ...
      "fixed-cost-reduction.html",
      "固定費を見る",
      "side-fire-roadmap-to-fixed-cost-reduction"
    ]
  ],
  "fire-cost-optimization": [
    [
      ...
      "project-fire.html",
      "記録を読む",
      "fire-cost-optimization-to-project-fire"
    ],
    [
      "投資確認",
      "NISA積立を確認する",
      ...
      "nisa.html",
      "NISAを見る",
      "fire-cost-optimization-to-nisa"
    ],
    [
      "家計改善",
      "固定費削減の効果を見る",
      ...
      "fixed-cost-reduction.html",
      "固定費を見る",
      "fire-cost-optimization-to-fixed-cost-reduction"
    ]
  ],
  "fire-stress": [
    [
  ...
  "cash-flow": [
    ...
    [
      "守りを固める",
      "生活防衛資金を確認する",
      "投資前に、急な支出へ備える現金が足りているか見ておくと安心です。",
      "生活防衛資金シミュレーター",
      "emergency-fund.html",
      "防衛資金を見る",
      "cash-flow-to-emergency-fund"
    ],
    [
      "目標へ接続",
      "FIREまでの距離を見る",
      "毎月残せる金額をもとに、会社に依存しない生活までの距離を確認します。",
      "FIRE達成シミュレーター",
      "fire.html",
      "FIREを試算する",
      "cash-flow-to-fire"
  ...
  "life-cost": [
    ...
    [
      "全体確認",
      "毎月の収支を整理する",
      "固定費や生活防衛資金を、家計全体の黒字額と合わせて確認します。",
      "キャッシュフローシミュレーター",
      "cash-flow.html",
      "収支を見る",
      "life-cost-to-cash-flow"
    ]
  ],
  "dividend": [
    [
      "次の一手",
      "配当再投資を確認する",
      "配当を受け取るだけでなく、再投資した場合の複利効果も確認できます。",
      "配当再投資シミュレーター",
    ...
    [
      "目標へ接続",
      "FIREまでの距離を見る",
      "配当収入や資産形成が、FIRE計画にどう影響するか確認します。",
      "FIRE達成シミュレーター",
      "fire.html",
      "FIREを見る",
      "dividend-to-fire"
  ...
  "dividend-etf": [
    [
      ...
      "dividend-reinvestment.html",
      "再投資を見る",
      "dividend-etf-to-dividend-reinvestment"
    ],
    [
      "制度確認",
      "NISAで積み立てる場合を見る",
  ...
  "dividend-stock": [
    [
      ...
      "dividend-reinvestment.html",
      "再投資を見る",
      "dividend-stock-to-dividend-reinvestment"
    ],
    [
      "制度確認",
      "NISAで積み立てる場合を見る",
  ...
  "dividend-mental": [
    [
      ...
      "dividend-reinvestment.html",
      "再投資を見る",
      "dividend-mental-to-dividend-reinvestment"
    ],
    [
      "制度確認",
      "NISAで積み立てる場合を見る",
  ...
  "dividend-reinvestment": [
    [
      ...
      "dividend-reinvestment.html",
      "再投資を見る",
      "dividend-reinvestment-to-dividend-reinvestment"
    ],
    [
      "制度確認",
      "NISAで積み立てる場合を見る",
  ...
  "dividend-life": [
    [
      ...
      "dividend-reinvestment.html",
      "再投資を見る",
      "dividend-life-to-dividend-reinvestment"
    ],
    [
      "制度確認",
      "NISAで積み立てる場合を見る",
  ...
  "dividend-life-years": [
    [
      ...
      "dividend-reinvestment.html",
      "再投資を見る",
      "dividend-life-years-to-dividend-reinvestment"
    ],
    [
      "制度確認",
      "NISAで積み立てる場合を見る",
  ...
  "side-fire": [
    ...
    [
      ...
      "fixed-cost-reduction.html",
      "固定費を見る",
      "side-fire-to-fixed-cost-reduction"
    ]
  ],
  "emergency-fund": [
    [
  ...
  "fixed-cost-reduction": [
    ...
    [
      ...
      "cash-flow.html",
      "収支を見る",
      "fixed-cost-reduction-to-cash-flow"
    ]
  ],
  "retirement": [
    [
      "次の一手",
      "毎月の収支を確認する",
      "将来支出が見えたら、毎月どれくらい準備できるかを確認します。",
      "キャッシュフローシミュレーター",
      "cash-flow.html",
      "収支を見る",
      "retirement-to-cash-flow"
    ],
    [
      "資産形成",
      "NISAで準備する場合を見る",
      "長期の支出に備えるため、積立額と将来資産の目安を確認します。",
      "新NISAシミュレーター",
      "nisa.html",
      "NISAを見る",
      "retirement-to-nisa"
    ...
    [
      "将来目標",
      "FIREとの距離を見る",
      "老後や住宅などの支出も含めて、会社に依存しない生活の距離感を見ます。",
      "FIRE達成シミュレーター",
      "fire.html",
      "FIREを見る",
      "retirement-to-fire"
  ...
  "education-insurance": [
    [
      ...
      "cash-flow.html",
      "収支を見る",
      "education-insurance-to-cash-flow"
    ],
    [
      "資産形成",
      "NISAで準備する場合を見る",
...
const resultReadingOverrides = {
  "side-income": [
    ["副業収入の位置付け", "月収だけで判断せず、本業後に続けられる作業時間と実質時給を合わせて見ると、現在地をつかみやすくなります。"],
    ["生活への影響", "月1万円、3万円、5万円など生活費や貯蓄に与える影響を小さく分けて考えると、無理のない目標を置きやすくなります。"],
    ["税金を考慮する必要性", "売上が増えても、経費や税金を差し引いた後の手取りは変わります。手取りや税金のページでも概算を確認してください。"],
  ],
  "take-home": [
    ["手元に残る金額", "売上ではなく、経費や税金を引いた後の金額を見て、生活費、貯蓄、投資へ回せる余力を確認します。"],
    ["税金の影響", "所得税や住民税の率は人によって変わるため、結果は固定額ではなく概算の目安として扱ってください。"],
    ["次の判断材料", "手取りが目標に届かない場合は、売上を増やす、経費を見直す、作業単価を上げるなど複数の選択肢で考えます。"],
  ],
  tax: [
    ["税負担の大きさ", "課税所得、所得税、住民税を分けて見ることで、納税用にどれくらい残しておくかの目安を立てやすくなります。"],
    ["手取りへの影響", "税金を引いた後に使える金額は別途確認が必要です。売上が増えた時ほど、手取り額も合わせて見てください。"],
    ["制度確認の必要性", "税率や控除、申告方法は条件で変わります。最終判断は国税庁、自治体、税理士などの情報も確認してください。"],
  ],
  fire: [
    ["現在の達成率", "必要資産に対して現在資産がどの位置にあるかを見ることで、FIREまでの距離感を確認できます。"],
    ["改善ポイント", "達成年数が長い場合は、積立額、生活費、利回り、副業収入のどれを見直すか分けて考えると判断しやすくなります。"],
    ["積立額変更の影響", "毎月の積立額を変えると、達成年数や将来資産が大きく変わる場合があります。複数パターンで比較してください。"],
  ],
  nisa: [
    ["長期積立の考え方", "毎月積立額、運用年数、想定利回りを分けて見ると、将来資産がどの条件に左右されるか分かりやすくなります。"],
    ["家計とのバランス", "積立額が大きいほど将来資産は増えやすい一方、生活防衛資金や毎月収支に無理がないか確認することが大切です。"],
    ["リスクの注意点", "想定利回りは将来の成果を保証するものではありません。低めの利回りや途中で積立を止める場合も試してください。"],
  ],
};

const resultReadingTemplates = {
  side: [
    ["収入の現在地", "{title}の結果は、今の副業条件が目標にどれくらい近いかを見るための目安です。売上だけでなく、時間や経費も合わせて確認してください。"],
    ["続けやすさ", "会社員の副業では、本業後に無理なく続けられるかが大切です。大きな数字だけでなく、疲労や作業時間も判断材料にしてください。"],
    ["次に見る数字", "収入が見えたら、税金、手取り、利益率も確認すると、実際に残るお金を把握しやすくなります。"],
  ],
  ai: [
    ["効率化の効果", "{title}の結果は、AI活用で時間や費用がどれくらい変わるかを見るための目安です。削減時間だけでなく、品質確認の手間も残る前提で考えてください。"],
    ["費用対効果", "有料ツールや自動化は、月額費用を上回る効果があるかを確認することが大切です。小さく試してから広げると判断しやすくなります。"],
    ["副業へのつなげ方", "浮いた時間を休息、営業、単価改善のどれに使うかで結果は変わります。時間短縮そのものを目的にしすぎないようにしてください。"],
  ],
  tax: [
    ["税負担の目安", "{title}の結果は、税金や控除の影響を事前に把握するための概算です。税率や制度は条件で変わるため、固定額として扱わないでください。"],
    ["資金準備", "税額が見えたら、納税用に分ける金額や手取り額も確認すると、あとから慌てにくくなります。"],
    ["公式情報の確認", "申告や控除の最終判断は、公的機関や専門家の情報も確認してください。シミュレーターは判断前の整理に使うものです。"],
  ],
  investment: [
    ["長期目線", "{title}の結果は、積立額、期間、利回りの組み合わせを確認するための目安です。短期の増減ではなく、長く続けられる条件かを見てください。"],
    ["リスクの見方", "想定利回りや配当は将来の成果を保証しません。低めの条件や一時的に下落する場合も置いて確認すると安心です。"],
    ["家計との接続", "投資額は毎月収支や生活防衛資金とセットで考える必要があります。無理のない金額から始める方が続けやすくなります。"],
  ],
  fire: [
    ["目標までの距離", "{title}の結果は、必要資産や達成年数を分解して、今どこにいるかを確認するための目安です。"],
    ["改善の方向", "達成まで遠い場合は、積立額を増やすだけでなく、生活費、固定費、副業収入、投資期間を分けて見直してください。"],
    ["前提の確認", "利回り、生活費、収入は変動します。楽観的な条件だけでなく、保守的な条件でも試すことが大切です。"],
  ],
  household: [
    ["毎月の余力", "{title}の結果は、収入と支出の差から、貯蓄や投資へ回せる余力を確認するための目安です。"],
    ["先に整える場所", "赤字や余力不足がある場合は、投資額を増やす前に固定費や生活防衛資金を確認すると判断しやすくなります。"],
    ["資産形成へのつなげ方", "黒字分や削減できた支出は、すぐ使い切らず、貯蓄やNISAなどへ回す選択肢も考えられます。"],
  ],
  life: [
    ["将来支出の見方", "{title}の結果は、教育費、老後資金、住宅費など大きな支出を早めに把握するための目安です。"],
    ["不足額の扱い", "不足が出ても、すぐに無理な積立へ変える必要はありません。期間、支出、収入、制度活用を分けて調整してください。"],
    ["他の目標とのバランス", "老後資金、教育費、住宅費、投資はつながっています。一つの目標だけでなく、家計全体で確認することが大切です。"],
  ],
  default: [
    ["結果の位置付け", "{title}の結果は、入力条件をもとにした概算です。実際の収入、支出、税金、投資成果を保証するものではありません。"],
    ["判断の進め方", "一度の計算だけで結論を出さず、条件を変えながら複数パターンで確認すると、自分に合う範囲が見えやすくなります。"],
    ["次に確認する項目", "結果を見たあとは、関連する税金、手取り、家計、資産形成のページも合わせて確認してください。"],
  ],
};

function escapeResultReadingText(value) {
...
function getResultReadingItems(route) {
  const profile = routeExperienceProfiles[route];
  const title = profile?.title || (routeSeo[route]?.title || "このシミュレーター").split("｜")[0];
  const kind = profile?.kind || getJourneyKind(route) || "default";
  const template = resultReadingOverrides[route] || resultReadingTemplates[kind] || resultReadingTemplates.default;
  return template.map(([heading, body]) => [
    escapeResultReadingText(heading),
    escapeResultReadingText(body.replaceAll("{title}", title)),
  ]);
}

function renderResultReadingSection(route) {
  const view = document.querySelector(`.view[data-view="${route}"]`);
  if (!view || route === "top" || view.querySelector(".result-reading-panel")) {
    return;
  }

  const resultPanel = view.querySelector(".workspace .result-panel");
  if (!resultPanel) {
    return;
  }

  const items = getResultReadingItems(route);
  const itemHtml = items.map(([heading, body]) => `
    <li>
      <strong>${heading}</strong>
      <span>${body}</span>
    </li>`).join("");

  resultPanel.insertAdjacentHTML("afterend", `
    <section class="article-panel result-reading-panel" aria-label="この結果から分かること">
      <section class="tool-heading">
        <h2>この結果から分かること</h2>
        <p>表示された数字を、次の判断に使うための見方を整理します。</p>
      </section>
      <ul class="result-reading-list">
        ${itemHtml}
      </ul>
      <p class="result-reading-note">結果は入力条件にもとづく概算です。税制、制度、投資環境、生活状況は変わる可能性があるため、必要に応じて公的情報や専門家の情報も確認してください。</p>
    </section>`);
}
...
function renderNextStepSection(route) {
  ...
  const view = document.querySelector(`.view[data-view="${route}"]`);
  if (!cards || !view || view.querySelector(".next-recommend-panel")) {
    return;
  }
  ...
  const cardHtml = cards.map(([label, title, reason, destination, href, buttonText, dataKey], index) => `
    <a class="next-step-card next-recommend-card${index === 0 ? " is-primary" : ""}" href="${href}" data-next-recommend="${dataKey}">
  ...
  view.insertAdjacentHTML("beforeend", `
    <section class="article-panel next-step-panel next-recommend-panel" aria-label="次におすすめ">
      <section class="tool-heading">
        <h2>次におすすめ</h2>
        <p>今回の結果をもとに、次に知りたい情報へ自然に進めるページを案内します。</p>
      </section>
      <div class="next-step-grid next-recommend-grid">
        ${cardHtml}
      </div>
...
function renderRoute() {
  ...
  renderResultReadingSection(route);
...
function insertExistingPageSeoImprovements() {
  ...
  Object.entries(sections).forEach(([route, html]) => {
    const view = document.querySelector('[data-view="' + route + '"]');
    if (!view || view.querySelector('[data-seo-existing="true"]')) return;
    const wrapper = document.createElement('div');
    wrapper.dataset.seoExisting = 'true';
...
document.querySelector("#sideFireRoadmapForm").addEventListener("input", renderSideFireRoadmap);
document.querySelector("#sideFireRoadmapForm").addEventListener("reset", () => {
  window.requestAnimationFrame(renderSideFireRoadmap);
});
