# 会社員キャッシュフローシミュレーター追加 手動アップロード用
...
<html lang="ja">
  <head>
    ...
    <meta name="description" content="副業、税金、投資、FIRE、老後資金、教育費、住宅ローン、固定費削減、AI副業効率化、副業時間管理、会社員キャッシュフローまで、27種類の初心者向けシミュレーターを検索・カテゴリ別・人気順で探せるスマホ対応サイトです。">
    <title>【2026年対応】初心者向け資産シミュレーター27選｜検索・カテゴリ別で探せる</title>
    <link rel="stylesheet" href="style.css">
    <script>
      window.GA_MEASUREMENT_ID = "G-XM73JD15LP";
    </script>
    <script defer src="script.js?v=20260607-cash-flow"></script>
  </head>
  <body></body>
</html>
...
<html lang="ja">
  <head>
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1671825304176893"
     crossorigin="anonymous"></script>
    <meta name="google-site-verification" content="W8lV0ZXsiS6lCYIRGsdxAnk8X0vIfJix8UBz6ie2gnc" />
    <meta http-equiv="refresh" content="0; url=index.html#cash-flow">
    <meta name="description" content="給与収入、副業収入、家賃、食費、通信費、保険料、投資額、ローン返済額、その他支出から、毎月収支、年間貯蓄額、投資可能額、固定費改善余地、FIRE達成への影響を分析できます。">
    <title>【2026年対応】初心者向け会社員キャッシュフローシミュレーター｜3分で家計改善</title>
    <link rel="stylesheet" href="style.css">
    <script>
      window.GA_MEASUREMENT_ID = "G-XM73JD15LP";
    </script>
  ...
  <body>
    <main>
      <div class="app-shell">
        <p><a href="index.html#cash-flow">会社員キャッシュフローシミュレーターを開く</a></p>
        <footer class="site-footer">
          <nav class="footer-links" aria-label="サイト情報">
            <a href="index.html#top">トップ</a>
            <a href="index.html#cash-flow">会社員キャッシュフロー</a>
            <a href="index.html#fixed-cost-reduction">固定費削減</a>
...
<html lang="ja">
  <head>
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1671825304176893"
     crossorigin="anonymous"></script>
    <meta name="description" content="FIRE、会社員FIRE、会社員キャッシュフロー、サイドFIRE、生活防衛資金、固定費削減、NISA取り崩し、配当再投資、配当生活達成、新NISA、老後資金をまとめたFIREカテゴリページです。">
  ...
  <body>
    <main>
      <div class="app-shell content-page">
        <header class="header">
          <h1>FIREカテゴリ</h1>
          <p class="lead">FIREを目指す人向けに、必要資産、達成年数、副業収入、会社員キャッシュフロー、固定費削減、NISA取り崩し、配当再投資、配当生活達成、生活防衛資金、サイドFIREの考え方をまとめています。</p>
        ...
        <section class="content-panel">
          ...
          <div class="article-list">
            ...
            <a class="article-link" href="index.html#cash-flow">
              <strong>会社員キャッシュフローシミュレーター</strong>
              <span>毎月収支、投資可能額、固定費改善余地を確認</span>
            </a>
